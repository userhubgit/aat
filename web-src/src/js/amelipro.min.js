...
$(document).ready(function(){function e(e,t){n=e,c=t}function t(e,t){""!=t&&($("#options-recherche").hide(),$("#validation-recherche, #avis-recherche").fadeIn("slow"),$("#nom-motif-selectionne").text(t),$("#id-motif-selectionne").val(e),e||(o("motif-origine","SAISIE",1),$("#categorie-motif").show(),$(".btn-group.bootstrap-select.row.small-spacer.form-control").addClass("open")),o("libelle",t.replace(/ /g,"_"),1))}function i(){$("#options-recherche").fadeIn("slow"),$("#validation-recherche, #avis-recherche").hide(),$("#categorie-motif").hide(),$("#nom-motif-selectionne").text(""),$("#id-motif-selectionne").val(""),$("#motif-aat-input").val(""),$("#complement-info-motif").val(""),document.getElementsByClassName("filter-option pull-left")[0].innerHTML="-- Catégorie de pathologies --",$("#recherche-button").removeClass("focus"),n=null,c=null,document.cookie="resultat-recherche=;expires=Wed; 01 Jan 1970",document.cookie="recherche-commentaire=;expires=Wed; 01 Jan 1970",document.cookie="motif-complement=;expires=Wed; 01 Jan 1970",document.cookie="motif-origine=;expires=Wed; 01 Jan 1970",o("motif-origine","LISTE_COMPLETE",1),o("clic-en-ce-moment","NON",1),o("clic-liste-complete","NON",1)}function a(e){for(var t=e+"=",i=document.cookie.split(";"),a=0;a<i.length;a++){for(var o=i[a];" "==o.charAt(0);)o=o.substring(1);if(0==o.indexOf(t))return o.substring(t.length,o.length)}return""}function o(e,t,i){var a=new Date;a.setTime(a.getTime()+24*i*60*60*1e3);var o="expires="+a.toUTCString();document.cookie=e+"="+t+";"+o+";path=/"}$('[data-toggle="popover"]').popover(),$("select").selectpicker(),$(".checkbox, .radio").click(function(){$(this).find("label").removeClass("active"),$(this).find("input:checked").parent("label").addClass("active")}),$(".checkbox, .radio").each(function(){$(this).find("label").removeClass("active"),$(this).find("input:checked").parent("label").addClass("active")}),$(".btn-menu, .overlay").click(function(){$("#main-menu").hasClass("open")?$("#main-menu, .overlay").removeClass("open"):$("#main-menu, .overlay").addClass("open")}),$(".datepicker, .input-group.date").attr({readonly:"readonly"}).datepicker({todayHighlight:!0,clearBtn:!0,language:"fr",autoclose:!0}),$(document).keyup(function(e){27==e.keyCode&&$("#main-menu, .overlay").removeClass("open")}),$(".show-hide-btn").each(function(){$(".show-hide-btn").find("span").addClass($(this).attr("data-hide-icon"))}),$(".show-hide-btn").click(function(){$(this).find("span").addClass($(this).attr("data-show-icon"))}),$(".show-hide").click(function(){var e=$(this).attr("data-hide"),t=$(this).attr("data-show"),i=$(this).attr("id");"smiles-positif"===i&&(document.cookie="recherche-commentaire=;expires=Wed; 01 Jan 1970",o("resultat-recherche","OUI",1)),"smiles-negatif"===i&&o("resultat-recherche","NON",1),"smiles-passif"===i&&o("resultat-recherche","MOYEN",1);var a=$(this).attr("data-reverse-show-hide");""!=e&&($(e).hide(),$(this).find(".open-close").removeClass("active")),""!=t&&($(t).removeClass("hidden"),$(t).fadeOut().fadeIn(),$(this).find(".open-close").addClass("active")),a&&($(this).attr("data-hide",t),$(this).attr("data-show",e)),$("#options-maquette li").removeClass("active"),$(this).addClass("active")}),$(".ajax-loader").hide(),$(".panel-heading[data-toggle=collapse]").click(function(){$(".panel-heading").removeClass("active"),$(this).addClass("active")}),$(".alphabet .lettre.active").click(function(){var e=$("#"+$(this).text()).offset().top-$(".liste-motifs").offset().top+$(".liste-motifs").scrollTop();$(".liste-motifs").animate({scrollTop:e},50),$(".alphabet .lettre.active").removeClass("selected"),$(this).addClass("selected"),document.cookie="clic-liste-complete=;expires=Wed; 01 Jan 1970",o("clic-liste-complete","OUI",1)}),$("#recherche-commentaire").on("keyup change",function(){o("recherche-commentaire",$(this).val().replace(/ /g,"_"),1)}),$(".alphabet .lettre.active").click(function(){$(".alphabet .lettre.active").removeClass("selected"),$(this).addClass("selected")}),$("#motifs-en-ce-moment .capsule").click(function(){document.cookie="clic-en-ce-moment=;expires=Wed; 01 Jan 1970",o("clic-en-ce-moment","OUI",1),document.cookie="motif-origine=;expires=Wed; 01 Jan 1970",o("motif-origine","EN_CE_MOMENT",1)}),$("#complement-info-motif").on("keyup change",function(){var e=$(this).val();max=500,textLength=e.length,textLength<max?$($(this).attr("data-compteur")).html(textLength+"/"+max):($(this).val(e.substring(0,max)),$($(this).attr("data-compteur")).html(max+"/"+max)),o("motif-complement",$(this).val().replace(/ /g,"_"),1)}),document.cookie="motif-complement=;expires=Wed; 01 Jan 1970",o("motif-origine","LISTE_COMPLETE",1),o("clic-en-ce-moment","NON",1),o("clic-liste-complete","NON",1),o("motif-complement","",1),o("recherche-commentaire","",1),o("avis-commentaire","",1),o("resultat-recherche","",1);var n=null,c=null,s={url:function(){return"/aat/motif?param="+$("#motif-aat-input").val()},getValue:"value",adjustWidth:!1,minCharNumber:2,list:{maxNumberOfElements:10,match:{enabled:!1},onShowListEvent:function(){var t=$("#motif-aat-input").getSelectedItemIndex(),i=$("#motif-aat-input").getItems();if(-1==t&&i.length>0){var a=i[0];e(a.label,a.value)}},onChooseEvent:function(){t($("#motif-aat-input").getSelectedItemData().label,$("#motif-aat-input").getSelectedItemData().value),document.cookie="motif-origine=;expires=Wed; 01 Jan 1970",o("motif-origine","SAISIE",1)}}};$("#motif-aat-input").easyAutocomplete(s),$("#motif-aat-input").on("keypress",function(e){var i=e.which;String.fromCharCode(e.which).match(/[A-Za-z0-9àâäéèêëîôöùûïÄÀÂÇÉÈÊÔÖÎÏÛÙ -]/)?13==i&&n&&c&&(t(n,c),document.cookie="motif-origine=;expires=Wed; 01 Jan 1970",o("motif-origine","SAISIE",1)):8!=e.which&&e.preventDefault()}),$("#motif-aat-input").keyup(function(e){if($(this).val().length>=2?$("#recherche-button").addClass("focus"):$("#recherche-button").removeClass("focus"),13==e.keyCode&&$(this).val().length>=2)return n&&c?t(n,c):t(!1,$("#motif-aat-input").val()),document.cookie="motif-origine=;expires=Wed; 01 Jan 1970",o("motif-origine","SAISIE",1),!1}),$("#liste-categorie").addClass("open"),$("#categorie-motif .bootstrap-select").addClass("open"),$("#recherche-button").click(function(e){t(!1,$("#motif-aat-input").val()),$("#liste-categorie").addClass("open"),e.stopPropagation(),$("#categorie-motif .bootstrap-select").addClass("open")}),$("[data-nom-motif]").click(function(){t($(this).data("id-motif"),$(this).data("nom-motif"))}),$("#reset-motif, #btn-nuovelle-recherche").click(function(){i()}),$(".capsule").click(function(){if($(this).data("parent")){$($(this).data("parent")+" .capsule").removeClass("active"),$(this).addClass("active");var e=$(this).parent().attr("id"),t=$(this).text();"options-avis-recherche-1"===e?o("avis-reponse1",t,1):o("avis-reponse2",t,1)}}),$("#someButton").click(function(){$("#myForm").submit()}),$("#avis-envoie").click(function(e){if(a("avis-reponse1")&&a("avis-reponse2")){return o("avis-commentaire",$("#avis-commentaire").val().replace(/ /g,"_"),1),!0}return $("#exemple-modal").modal("show"),!1})});
