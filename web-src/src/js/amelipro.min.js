...
$(document).ready(function(){function e(e,t){""!=t&&($("#options-recherche").hide(),$("#validation-recherche, #avis-recherche").fadeIn("slow"),$("#nom-motif-selectionne").text(t),$("#id-motif-selectionne").val(e),e||($("#motif-origine").val("SAISIE"),$("#categorie-motif").show()),$("#libelle").val(t))}function t(){$("#options-recherche").fadeIn("slow"),$("#validation-recherche, #avis-recherche").hide(),$("#categorie-motif").hide(),$("#nom-motif-selectionne").text(""),$("#id-motif-selectionne").val(""),$("#motif-aat-input").val(""),$("#complement-info-motif").val(""),document.getElementsByClassName("filter-option pull-left")[0].innerHTML="-- Catégorie de pathologies --",$("#recherche-button").removeClass("focus"),a=null,i=null,$("#motif-origine").val("LISTE_COMPLETE"),$("#clic-en-ce-moment").val("NON"),$("#clic-liste-complete").val("NON")}$('[data-toggle="popover"]').popover(),$("select").selectpicker(),$(".checkbox, .radio").click(function(){$(this).find("label").removeClass("active"),$(this).find("input:checked").parent("label").addClass("active")}),$(".checkbox, .radio").each(function(){$(this).find("label").removeClass("active"),$(this).find("input:checked").parent("label").addClass("active")}),$(".btn-menu, .overlay").click(function(){$("#main-menu").hasClass("open")?$("#main-menu, .overlay").removeClass("open"):$("#main-menu, .overlay").addClass("open")}),$(".datepicker, .input-group.date").attr({readonly:"readonly"}).datepicker({todayHighlight:!0,clearBtn:!0,language:"fr",autoclose:!0}),$(document).keyup(function(e){27==e.keyCode&&$("#main-menu, .overlay").removeClass("open")}),$(".show-hide-btn").each(function(){$(".show-hide-btn").find("span").addClass($(this).attr("data-hide-icon"))}),$(".show-hide-btn").click(function(){$(this).find("span").addClass($(this).attr("data-show-icon"))}),$(".show-hide").click(function(){var e=$(this).attr("data-hide"),t=$(this).attr("data-show"),a=$(this).attr("id");"smiles-positif"===a&&$("#resultat-recherche").val("OUI"),"smiles-negatif"===a&&$("#resultat-recherche").val("NON"),"smiles-passif"===a&&$("#resultat-recherche").val("MOYEN");var i=$(this).attr("data-reverse-show-hide");""!=e&&($(e).hide(),$(this).find(".open-close").removeClass("active")),""!=t&&($(t).removeClass("hidden"),$(t).fadeOut().fadeIn(),$(this).find(".open-close").addClass("active")),i&&($(this).attr("data-hide",t),$(this).attr("data-show",e)),$("#options-maquette li").removeClass("active"),$(this).addClass("active")}),$(".ajax-loader").hide(),$(".panel-heading[data-toggle=collapse]").click(function(){$(".panel-heading").removeClass("active"),$(this).addClass("active")}),$(".alphabet .lettre.active").click(function(){var e=$("#"+$(this).text()).offset().top-$(".liste-motifs").offset().top+$(".liste-motifs").scrollTop();$(".liste-motifs").animate({scrollTop:e},50),$(".alphabet .lettre.active").removeClass("selected"),$(this).addClass("selected"),$("#clic-liste-complete").val("OUI")}),$("#recherche-commentaire").on("keyup change",function(){$("#recherche-commentaire").val($(this).val())}),$(".alphabet .lettre.active").click(function(){$(".alphabet .lettre.active").removeClass("selected"),$(this).addClass("selected")}),$("#motifs-en-ce-moment .capsule").click(function(){$("#clic-en-ce-moment").val("OUI"),$("#motif-origine").val("EN_CE_MOMENT")}),$("#complement-info-motif").on("keyup change",function(){var e=$(this).val();max=500,textLength=e.length,textLength<max?$($(this).attr("data-compteur")).html(textLength+"/"+max):($(this).val(e.substring(0,max)),$($(this).attr("data-compteur")).html(max+"/"+max)),$("#motif-complement").val($(this).val())}),$("#motif-origine").val("LISTE_COMPLETE"),$("#clic-en-ce-moment").val("NON"),$("#clic-liste-complete").val("NON"),$("#resultat-recherche").val("");var a=null,i=null;$.ui.autocomplete.prototype._renderItem=function(e,t){return t.propDuree=t.value,t.propDuree=t.propDuree.replace(new RegExp("(?![^&;]+;)(?!<[^<>]*)("+$.ui.autocomplete.escapeRegex(this.term)+")(?![^<>]*>)(?![^&;]+;)","gi"),"<strong>$1</strong>"),$("<li></li>").data("item.autocomplete",t).append("<a>"+t.propDuree+"</a>").appendTo(e)},$("#motif-aat-input").autocomplete({source:function(e,t){$.ajax({type:"GET",url:"/aat/motif?param="+$("#motif-aat-input").val(),dataType:"json",success:function(e){t($.map(e,function(e){return e}))},error:function(){alert("La requête n'a pas abouti")}})},minLength:2,delay:0,select:function(t,o){9!=t.keyCode&&(i=$(this).val(),o.item.value.length>0&&(i=o.item.value,a=o.item.label,o.item.value=""),e(a,i))},response:function(e,t){0==t.content.length&&(i="")}}),$("#motif-aat-input").keyup(function(t){if(t.key.match(/[A-Za-z0-9àâäéèêëîôöùûïÄÀÂÇÉÈÊÔÖÎÏÛÙ -']/)||t.preventDefault(),$(this).val().length>=2?$("#recherche-button").addClass("focus"):$("#recherche-button").removeClass("focus"),13==t.keyCode)return $(this).val().length>=2&&(a&&i?e(a,i):e(!1,$("#motif-aat-input").val()),$("#motif-origine").val("SAISIE"),!1)}),$("#motif-aat-input").keypress(function(t){if(t.key.match(/[A-Za-z0-9àâäéèêëîôöùûïÄÀÂÇÉÈÊÔÖÎÏÛÙ -']/)||t.preventDefault(),$(this).val().length>=2?$("#recherche-button").addClass("focus"):$("#recherche-button").removeClass("focus"),13==t.keyCode)return $(this).val().length>=2&&(a&&i?e(a,i):e(!1,$("#motif-aat-input").val()),$("#motif-origine").val("SAISIE"),!1)}),$("#recherche-button").click(function(t){e(!1,$("#motif-aat-input").val())}),$("[data-nom-motif]").click(function(){e($(this).data("id-motif"),$(this).data("nom-motif"))}),$("#reset-motif, #btn-nuovelle-recherche").click(function(){t()}),$(".capsule").click(function(){if($(this).data("parent")){$($(this).data("parent")+" .capsule").removeClass("active"),$(this).addClass("active");var e=$(this).parent().attr("id"),t=$(this).text();"options-avis-recherche-1"===e?$("#avis-reponse1").val(t):$("#avis-reponse2").val(t)}}),$("#avis-envoie").click(function(e){if($("#avis-reponse1").val()&&$("#avis-reponse2").val()){var t=$("#avis-commentaire").val();return $("#avis-commentaire").val(t),!0}return $("#exemple-modal").modal("show"),!1})});
