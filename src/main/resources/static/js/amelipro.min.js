...
$(document).ready(function(){function e(e,t){o=e,s=t}function t(e,t){""!=t&&($("#options-recherche").hide(),$("#validation-recherche, #avis-recherche").fadeIn("slow"),$("#nom-motif-selectionne").text(t),$("#id-motif-selectionne").val(e),e||$("#categorie-motif").show(),n("libelle",t.replace(/ /g,"_"),1))}function a(){$("#options-recherche").fadeIn("slow"),$("#validation-recherche, #avis-recherche").hide(),$("#categorie-motif").hide(),$("#nom-motif-selectionne").text(""),$("#id-motif-selectionne").val(""),$("#motif-aat-input").val(""),$("#recherche-button").removeClass("focus"),o=null,s=null}function i(e){for(var t=e+"=",a=document.cookie.split(";"),i=0;i<a.length;i++){for(var n=a[i];" "==n.charAt(0);)n=n.substring(1);if(0==n.indexOf(t))return n.substring(t.length,n.length)}return""}function n(e,t,a){var i=new Date;i.setTime(i.getTime()+24*a*60*60*1e3);var n="expires="+i.toUTCString();document.cookie=e+"="+t+";"+n+";path=/"}$('[data-toggle="popover"]').popover(),$("select").selectpicker(),$(".checkbox, .radio").click(function(){$(this).find("label").removeClass("active"),$(this).find("input:checked").parent("label").addClass("active")}),$(".checkbox, .radio").each(function(){$(this).find("label").removeClass("active"),$(this).find("input:checked").parent("label").addClass("active")}),$(".btn-menu, .overlay").click(function(){$("#main-menu").hasClass("open")?$("#main-menu, .overlay").removeClass("open"):$("#main-menu, .overlay").addClass("open")}),$(".datepicker, .input-group.date").attr({readonly:"readonly"}).datepicker({todayHighlight:!0,clearBtn:!0,language:"fr",autoclose:!0}),$(document).keyup(function(e){27==e.keyCode&&$("#main-menu, .overlay").removeClass("open")}),$(".show-hide-btn").each(function(){$(".show-hide-btn").find("span").addClass($(this).attr("data-hide-icon"))}),$(".show-hide-btn").click(function(){$(this).find("span").addClass($(this).attr("data-show-icon"))}),$(".show-hide").click(function(){var e=$(this).attr("data-hide"),t=$(this).attr("data-show"),a=$(this).attr("data-reverse-show-hide");""!=e&&($(e).hide(),$(this).find(".open-close").removeClass("active")),""!=t&&($(t).removeClass("hidden"),$(t).fadeOut().fadeIn(),$(this).find(".open-close").addClass("active")),a&&($(this).attr("data-hide",t),$(this).attr("data-show",e)),$("#options-maquette li").removeClass("active"),$(this).addClass("active")}),$(".ajax-loader").hide(),$(".panel-heading[data-toggle=collapse]").click(function(){$(".panel-heading").removeClass("active"),$(this).addClass("active")}),$(".alphabet .lettre.active").click(function(){var e=$("#"+$(this).text()).offset().top-$(".liste-motifs").offset().top+$(".liste-motifs").scrollTop();$(".liste-motifs").animate({scrollTop:e},50),$(".alphabet .lettre.active").removeClass("selected"),$(this).addClass("selected")}),$(".alphabet .lettre.active").click(function(){$(".alphabet .lettre.active").removeClass("selected"),$(this).addClass("selected")}),$("#motifs-plus-frequents .capsule").click(function(){}),$("#motifs-en-ce-moment .capsule").click(function(){}),$("#complement-info-motif").on("keyup change",function(){var e=$(this).val();max=500,textLength=e.length,textLength<max?$($(this).attr("data-compteur")).html(textLength+"/"+max):($(this).val(e.substring(0,max)),$($(this).attr("data-compteur")).html(max+"/"+max))});var o=null,s=null,c={url:function(){return"/aat/motif?param="+$("#motif-aat-input").val()},getValue:"value",adjustWidth:!1,minCharNumber:2,list:{maxNumberOfElements:10,match:{enabled:!1},onShowListEvent:function(){var t=$("#motif-aat-input").getSelectedItemIndex(),a=$("#motif-aat-input").getItems();if(-1==t&&a.length>0){var i=a[0];e(i.label,i.value)}},onChooseEvent:function(){t($("#motif-aat-input").getSelectedItemData().label,$("#motif-aat-input").getSelectedItemData().value)}}};$("#motif-aat-input").easyAutocomplete(c),$("#motif-aat-input").on("keypress",function(e){13==e.which&&o&&s&&t(o,s)}),$("#motif-aat-input").keyup(function(){o=null,s=null,$(this).val().length>=2?$("#recherche-button").addClass("focus"):$("#recherche-button").removeClass("focus")}),$("#recherche-button").click(function(){t(!1,$("#motif-aat-input").val())}),$("#motif-aat-input").keyup(function(e){if(13==e.keyCode)return t(!1,$("#motif-aat-input").val()),!1}),$("[data-nom-motif]").click(function(){t($(this).data("id-motif"),$(this).data("nom-motif"))}),$("#reset-motif, #btn-nuovelle-recherche").click(function(){a()}),$(".capsule").click(function(){if($(this).data("parent")){$($(this).data("parent")+" .capsule").removeClass("active"),$(this).addClass("active");var e=$(this).parent().attr("id"),t=$(this).text();"options-avis-recherche-1"===e?n("avis-reponse1",t,1):n("avis-reponse2",t,1)}}),$("#avis-envoie").click(function(e){if(i("avis-reponse1")&&i("avis-reponse2")){return n("avis-commentaire",$("#avis-commentaire").val().replace(/ /g,"_"),1),!0}return confirm("Merci de saisir vos réponse avant l'envoie"),!1})});
