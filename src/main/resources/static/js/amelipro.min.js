...
$(document).ready(function(){function t(t,e){i=t,n=e}function e(t,e){""!=e&&($("#options-recherche").hide(),$("#validation-recherche, #avis-recherche").fadeIn("slow"),$("#nom-motif-selectionne").text(e),$("#id-motif-selectionne").val(t),t||$("#categorie-motif").show())}function a(){$("#options-recherche").fadeIn("slow"),$("#validation-recherche, #avis-recherche").hide(),$("#categorie-motif").hide(),$("#nom-motif-selectionne").text(""),$("#id-motif-selectionne").val(""),$("#motif-aat-input").val(""),$("#recherche-button").removeClass("focus"),i=null,n=null}$('[data-toggle="popover"]').popover(),$("select").selectpicker(),$(".checkbox, .radio").click(function(){$(this).find("label").removeClass("active"),$(this).find("input:checked").parent("label").addClass("active")}),$(".checkbox, .radio").each(function(){$(this).find("label").removeClass("active"),$(this).find("input:checked").parent("label").addClass("active")}),$(".btn-menu, .overlay").click(function(){$("#main-menu").hasClass("open")?$("#main-menu, .overlay").removeClass("open"):$("#main-menu, .overlay").addClass("open")}),$(".datepicker, .input-group.date").attr({readonly:"readonly"}).datepicker({todayHighlight:!0,clearBtn:!0,language:"fr",autoclose:!0}),$(document).keyup(function(t){27==t.keyCode&&$("#main-menu, .overlay").removeClass("open")}),$(".show-hide-btn").each(function(){$(".show-hide-btn").find("span").addClass($(this).attr("data-hide-icon"))}),$(".show-hide-btn").click(function(){$(this).find("span").addClass($(this).attr("data-show-icon"))}),$(".show-hide").click(function(){var t=$(this).attr("data-hide"),e=$(this).attr("data-show"),a=$(this).attr("data-reverse-show-hide");""!=t&&($(t).hide(),$(this).find(".open-close").removeClass("active")),""!=e&&($(e).removeClass("hidden"),$(e).fadeOut().fadeIn(),$(this).find(".open-close").addClass("active")),a&&($(this).attr("data-hide",e),$(this).attr("data-show",t)),$("#options-maquette li").removeClass("active"),$(this).addClass("active")}),$(".ajax-loader").hide(),$(".panel-heading[data-toggle=collapse]").click(function(){$(".panel-heading").removeClass("active"),$(this).addClass("active")}),$(".alphabet .lettre.active").click(function(){var t=$("#"+$(this).text()).offset().top-$(".liste-motifs").offset().top+$(".liste-motifs").scrollTop();$(".liste-motifs").animate({scrollTop:t},50),$(".alphabet .lettre.active").removeClass("selected"),$(this).addClass("selected")}),$(".alphabet .lettre.active").click(function(){$(".alphabet .lettre.active").removeClass("selected"),$(this).addClass("selected")}),$("#complement-info-motif").on("keyup change",function(){var t=$(this).val();max=500,textLength=t.length,textLength<max?$($(this).attr("data-compteur")).html(textLength+"/"+max):($(this).val(t.substring(0,max)),$($(this).attr("data-compteur")).html(max+"/"+max))});var i=null,n=null,o={url:function(){return"/aat/motif?param="+$("#motif-aat-input").val()},getValue:"value",adjustWidth:!1,minCharNumber:2,list:{maxNumberOfElements:10,match:{enabled:!1},onShowListEvent:function(){var e=$("#motif-aat-input").getSelectedItemIndex(),a=$("#motif-aat-input").getItems();if(-1==e&&a.length>0){var i=a[0];t(i.label,i.value)}},onChooseEvent:function(){e($("#motif-aat-input").getSelectedItemData().label,$("#motif-aat-input").getSelectedItemData().value)}}};$("#motif-aat-input").easyAutocomplete(o),$("#motif-aat-input").on("keypress",function(t){13==t.which&&i&&n&&e(i,n)}),$("#motif-aat-input").keyup(function(){i=null,n=null,$(this).val().length>=2?$("#recherche-button").addClass("focus"):$("#recherche-button").removeClass("focus")}),$("#recherche-button").click(function(){e(!1,$("#motif-aat-input").val())}),$("#motif-aat-input").keyup(function(t){if(13==t.keyCode)return e(!1,$("#motif-aat-input").val()),!1}),$("[data-nom-motif]").click(function(){e($(this).data("id-motif"),$(this).data("nom-motif"))}),$("#reset-motif, #btn-nuovelle-recherche").click(function(){a()}),$(".capsule").click(function(){$(this).data("parent")&&($($(this).data("parent")+" .capsule").removeClass("active"),$(this).addClass("active"))})});
